...
The initial draft (Ver. 0.5, uploaded on July 27, 2024) is only a first pass (Ver. 0.52 just fixes some typos). Please send comments as pull requests. Harsh criticism is welcome but polite discourse is mandatory.
